...
<body>
	...
	<form method="post" action="${pageContext.request.contextPath }/ex04/sub02">
	<input type="submit" value="post 방식 전송">
	</form>

	<form method="get" action="${pageContext.request.contextPath }/ex04/sub03">
	<input type="submit" value="get sub03">
	</form>
	<form method="post" action="${pageContext.request.contextPath }/ex04/sub03">
	<input type="submit" value="post sub03">
	</form>

	<form method="get" action="${pageContext.request.contextPath }/ex04/sub04">
	<input type="submit" value="get sub04">
	</form>
	<form method="post" action="${pageContext.request.contextPath }/ex04/sub04">
	<input type="submit" value="post sub04">
	</form>
